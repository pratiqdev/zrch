...
//             keys = keys.concat(getUniqueKeys(value));
//         } else if (_.isArray(value)) {
//             value.forEach(item => {
//                 keys = keys.concat(getUniqueKeys(item));
//             });
//         }
//     });
...
function getUniqueKeys(obj, prefix = '') {
  let keys = [];
...
export const getProbableKeys = (data) => {
...
console.log(getProbableKeys(userData))